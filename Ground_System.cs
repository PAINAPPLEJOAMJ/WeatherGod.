...
public class Ground_System : FSM_Base
{
    ...
    void Start()
    {
        points = GameObject.Find("Ground_PointGroup").GetComponentsInChildren<Transform>();
    ...
    IEnumerator createPerson () 
    {
        while (true) 
        {
            ...
            if (pCnt < maxP) 
            {
                ...
                var G_Person = Instantiate(person[pIdx],
                ...
                G_Person.transform.parent = gameObject.transform;
            } 
            else if (pCnt == maxP) 
            {
                break;
